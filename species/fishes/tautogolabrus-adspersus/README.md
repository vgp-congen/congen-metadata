...
These calls were produced by the VGP Conservation Genomics project and published on GenomeArk under `GCA_020745685.1`. The reads they were called from were generated by other people; please cite the BioProjects below.

Citations are recorded for 150 of 150 samples (1 of 1 BioProjects).

- **[PRJNA982083](https://www.ncbi.nlm.nih.gov/bioproject/PRJNA982083)** · 150 samples · Whole genome sequencing reveals fine-scale environment associated divergence near the range limits of a temperate reef fish.
  - Nugent CM et al. (2023) Whole‐genome sequencing reveals fine‐scale environment‐associated divergence near the range limits of a temperate reef fish Molecular Ecology. [10.1111/mec.17063](https://doi.org/10.1111/mec.17063)
