...
These calls were produced by the VGP Conservation Genomics project and published on GenomeArk under `GCA_914725855.1`. The reads they were called from were generated by other people; please cite the BioProjects below.

Citations are recorded for 0 of 11 samples (0 of 3 BioProjects).

- **[PRJEB14402](https://www.ncbi.nlm.nih.gov/bioproject/PRJEB14402)** · 8 samples · Genomic insights reveal a shared demographic history of differentiated Atlantic and Indo-Pacific yellowfin tuna (Thunnus albacares) populations
  - *citation not yet reviewed*
- **[PRJNA504596](https://www.ncbi.nlm.nih.gov/bioproject/PRJNA504596)** · 2 samples · Thunnus albacares draft genome assembly and linkage map
  - *citation not yet reviewed*
- **[PRJEB45133](https://www.ncbi.nlm.nih.gov/bioproject/PRJEB45133)** · 1 sample · Thunnus albacares (yellowfin tuna), genomic and transcriptomic data
  - *citation not yet reviewed*
