...
These calls were produced by the VGP Conservation Genomics project and published on GenomeArk under `GCA_963854745.1`. The reads they were called from were generated by other people; please cite the BioProjects below.

Citations are recorded for 0 of 15 samples (0 of 4 BioProjects).

- **[PRJNA649485](https://www.ncbi.nlm.nih.gov/bioproject/PRJNA649485)** · 11 samples · Chromosome differentiaion between Z and W potentially involved in sex determination in turbot
  - *citation not yet reviewed*
- **[PRJNA542243](https://www.ncbi.nlm.nih.gov/bioproject/PRJNA542243)** · 2 samples · Draft genomes of female and male turbot (Scophthalmus maximus)
  - *citation not yet reviewed*
- **[PRJEB11743](https://www.ncbi.nlm.nih.gov/bioproject/PRJEB11743)** · 1 sample · WHOLE GENOME SEQUENCING OF TURBOT: A FISH ADAPTED TO DEMERSAL LIFE
  - *citation not yet reviewed*
- **[PRJNA792617](https://www.ncbi.nlm.nih.gov/bioproject/PRJNA792617)** · 1 sample · Identification of stress-related genes by co-expression network analysis based on the improved turbot genome
  - *citation not yet reviewed*
