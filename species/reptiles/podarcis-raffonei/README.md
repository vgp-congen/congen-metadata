...
|---|---|
| Clade | reptiles |
| Reference assembly | [`GCA_027172205.1`](https://www.ncbi.nlm.nih.gov/datasets/genome/GCA_027172205.1/) — rPodRaf1.pri, Chromosome |
...
| Properly paired | median 97.3% (range 96.2–99.6%) |
...
|  | Size |  |
|---|---:|---|
| [`raw.vcf.gz`][vcfs/raw.vcf.gz] | 1.4 GiB | unfiltered joint-genotyped calls |
| [`raw.vcf.gz.tbi`][vcfs/raw.vcf.gz.tbi] | 1.1 MiB | index for the above |
| [`callable_sites.bed`][callable_sites/callable_sites.bed] | 8.2 MiB | the callable-sites mask |
| [`qc_dashboard.html`][qc/qc_dashboard.html] | 8.6 MiB | the snpArcher QC report — opens in a browser |
| `bams/` | 243.5 GiB | 42 objects — alignments and indexes |
...
| [`callable_sites/coverage.bed`][callable_sites/coverage.bed] | 48.1 MiB |
...
[callable_sites/mappability.bedgraph]: https://genomeark.s3.amazonaws.com/downstream_analyses/conservation_genomics/variant_calling/GCA_027172205.1/callable_sites/mappability.bedgraph
